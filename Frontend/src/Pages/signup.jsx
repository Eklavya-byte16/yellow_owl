    ...
    <div className="w-full min-h-screen bg-black relative flex items-center justify-center p-4 selection:bg-white selection:text-black overflow-hidden font-sans">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-neutral-400 mt-1.5 font-medium">Get started with your personalized AI platform</p>
        </div>

        <form onSubmit={hangleSignup} className="space-y-5">
          <div>
            <label className="block text-xs font-mono uppercase tracking-wider text-neutral-400 mb-2 font-semibold">Username</label>
            <input 
              type="text" 
              name="username"
              value={form.username}
